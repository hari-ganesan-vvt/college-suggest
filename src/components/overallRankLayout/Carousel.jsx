...
const Carousel = ({ listdata }) => {
  ...
  // console.log(listdata.j_course);

  // listdata.j_course.map((courseName) => console.log(courseName));
  return (
    <div>
      <Swiper
        spaceBetween={10}
      ...
      >
        ...
        {/* <SwiperSlide>
          <div className="slidebx">
            <a className="linktitle">
              B.Tech Electronics and Communication Engineering 2
            </a>
            <div className="preseat">
              <div className="pretxt">
                <p>
        ...
        <SwiperSlide>
          <div className="slidebx">
            <a className="linktitle">
              B.Tech Electronics and Communication Engineering 3
            </a>
            <div className="preseat">
              <div className="pretxt">
                <p>
        ...
        <SwiperSlide>
          <div className="slidebx">
            <a className="linktitle">
              B.Tech Electronics and Communication Engineering 4
            </a>
            <div className="preseat">
              <div className="pretxt">
                <p>
